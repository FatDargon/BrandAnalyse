...
if __name__ == '__main__': 
    print "###########直方图的距离计算#############"
    print "相似度最高的图是" + readfolder('../Result/Area','../Result/Area/test.png',1)
    print "###########分块直方图的距离计算#############"
    print "相似度最高的图是" + readfolder('../Result/Area','../Result/Area/test.png',2)
    print "##############感知哈希算法###############"
    print "相似度最高的图是" + readfolder('../Result/Area','../Result/Area/test.png',3)